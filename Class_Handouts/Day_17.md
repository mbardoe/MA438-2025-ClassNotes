...
- $a_n = \left(\frac{3}{4}\right)^n$  
  ![Geometric sequence](img/limit_seq2_geom.png)

- $a_n = \sqrt{\frac{1}{n}}$  
  ![Square root decay](img/limit_seq3_sqrt.png)

- $t_n = 4+(-1)^n \cdot \left( \frac{3}{4} \right)^n$  
  ![Oscillating Geometric Sequence](img/limit_seq4_oscillating.png)

- $t_n = \frac{4n^2-n}{8n^2+n-40}$  
  ![Rational Function](img/limit_seq5_rational.png)
